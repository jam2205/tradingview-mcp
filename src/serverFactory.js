...
- jetson_annotate_confluence_badges_all_panes → in a multi-pane grid layout, draws a confluence badge on every pane's own symbol (not just the active one) in one call, then restores the originally active pane
