...
- jetson_annotate_seasonality → real day-of-week/hour-of-day (UTC) seasonality drawn as a chart flag. NOT a native Jetson dataset — computed here from real candles_1h history, because the only seasonality-shaped columns on Jetson (day_of_week/hour_utc in enriched_signals) live in a dead, superseded table that must never be used as a live signal. jetson_get_seasonality for the data alone. Always weigh by sample size (n); Saturday/most-Sunday buckets are legitimately n:0
